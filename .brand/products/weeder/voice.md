...
| allowance | suppression, ignore, override | A person let a finding through, on the record. `Weeder-allow` is the trailer; the allowance is a finding too. |
...
Restore them, or allow with a reason: Weeder-allow: T1 <reason>.`
