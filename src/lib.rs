...
//! (`garden.json` and `garden.lock`) and their schemas, and the layout of a planted
//! repository. Every path is a function of a repository root that the caller supplies;
